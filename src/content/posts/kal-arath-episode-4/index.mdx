...
description: >-
  Storm finally breaks. A hidden shrine reveals a rival cult, an angry giant
  ambushes the campfire, and the battle barge wreckage turns up at last.
date: 2026-05-08
type: live-play
format: video
...
system: Kal Arath
series: kal-arath-season-1
episode: 4
tags: ['kal-arath', 'castle-grief', 'solo-rpg', 'prima-materia']
draft: false
---
...
Garen tries to fire as the giant crashes in. Misses. Giant wins initiative and throws a **boulder.** Garen fails the dodge. I had fate points wrong, so I re-roll. Still fails. Six damage minus four armor — Garen drops to **two HP.** Not great.
...
Worth flagging: Kethris is technically a mage (we rolled that in episode three), but she didn't cast a single spell during the giant fight. The Man Alone Prima Materia dice told us she's still wary about revealing her magical nature to Garen. She's decided to stick around for the long haul, but she isn't ready to drop the cover yet. For now she's a giant praying mantis with claws and a leap, and the magic stays hidden.
